...
const TESTS = {
  addChrome(helper) {
    UA = "X";
    is(helper(), `X ${WEBKIT} Chrome/127.0 Safari/537.36`);
    is(helper(UA, "VER"), `X ${WEBKIT} Chrome/VER Safari/537.36`);

    UA = "X Mobile";
    is(helper(), `X Mobile ${WEBKIT} Chrome/127.0 Mobile Safari/537.36`);
    is(helper(UA, "VER"), `X Mobile ${WEBKIT} Chrome/VER Mobile Safari/537.36`);

    UA = "X Tablet";
    is(helper(), `X Tablet ${WEBKIT} Chrome/127.0 Mobile Safari/537.36`);
