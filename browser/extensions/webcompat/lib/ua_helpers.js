...
var UAHelpers = {
      ...
      if (OS === "android" || (noOSGiven && userAgent.includes("Android"))) {
        ...
        if (phone) {
          UAHelpers._deviceAppropriateChromeUAs[key] =
            `Mozilla/5.0 (Linux; ${AndroidVersion}; ${phone}) ${fxQuantum}AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0 Mobile Safari/537.36 Gecko/20100101 Firefox/120.0.0`;
        } else {
          UAHelpers._deviceAppropriateChromeUAs[key] =
            `Mozilla/5.0 (Linux; ${AndroidVersion}; ${tablet}) ${fxQuantum}AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0 Safari/537.36 Gecko/20100101 Firefox/120.0.0`;
        }
      } else {
        ...
        UAHelpers._deviceAppropriateChromeUAs[key] =
          `Mozilla/5.0 (${osSegment}) ${fxQuantum}AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0 Safari/537.36 Gecko/20100101 Firefox/120.0.0`;
      }
    }
  ...
  safari(config = {}) {
    ...
    return `Mozilla/5.0 (Macintosh; ${arch} Mac OS X ${osVersion}) ${firefox}AppleWebKit/${webkitVersion} (KHTML, like Gecko) Version/${version} Safari/${webkitVersion} Gecko/20100101 Firefox/120.0.0`;
  },
  ...
  getWindowsUA(originalUA) {
    ...
    return `Mozilla/5.0 (Windows NT 10.0; Win64; x64; ${rv}) Gecko/20100101 ${ver} Firefox/120.0.0`;
  },
};
